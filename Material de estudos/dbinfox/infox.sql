...
values('Vitor Marcelli','admin',md5('123456'),'administrador');
insert into usuarios(usuario,login,senha,perfil)
values('Tatiane Marcelli','tiane',md5('123'),'operador');
...
update usuarios set usuario='Tatiane Regina Marcelli',
login='tianemar',senha=md5('1234'),perfil='operador' where id=2;
